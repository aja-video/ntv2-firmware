mkdir srecords
powershell "(gc ..\sarek\konaIP_2in2out\mcs_components\build7.h | Format-Hex | Select-Object -Expand Bytes | ForEach-Object { '{0:x2}' -f $_}) -join '' > ..\sarek\konaIP_2in2out\mcs_components\build7.bin"
