...
- Verified the mic function by putting the device in loop through in the control panel, and then manually overriding the audio input control register to select the microphone port.
...
- added E2E connections for 12g passthrough, verified the following paths...
 - in1a to out1a   
 - in2a to out2a   
 - in3a to out3a   
 - in4a to out4a  
...
- fixed audio packetizer sample order when two samples on a line duplicated audio on links 2/3/4 in 6g/12g
...
- fixed ANC insert issue when sending null packets to field2 buffer 
- updated can_do to indicate HANC insertion capability
